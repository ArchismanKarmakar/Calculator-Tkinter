...
tk_calc = Tk()
tk_calc.configure(bg="#3C3636", bd=10)
...
text_display = Entry(tk_calc, font=('sans-serif', 20, 'bold'), textvariable=text_input,
                     bd=0, insertwidth=8, bg='#FFFFFF', justify='right').grid(columnspan=5, padx=0, pady=20)

button_params = {'bd': 0, 'fg': '#FFFFFF',
                 'bg': '#3C3636', 'font': ('sans-serif', 20, 'bold')}
button_params_main = {'bd': 0, 'fg': '#111',
                      'bg': '#f0f0f0', 'font': ('sans-serif', 20, 'bold')}
...
delete_one = Button(tk_calc, bd=0, fg='#000', font=('sans-serif', 20, 'bold'),
                    text='DEL', command=button_delete, bg='#e38502').grid(row=6, column=3, sticky="nsew")
delete_all = Button(tk_calc, bd=0, fg='#000', font=('sans-serif', 20, 'bold'),
                    text='AC', command=button_clear_all, bg='#e38502').grid(row=6, column=4, sticky="nsew")
